...
$query = "UPDATE $schema.dat_obj_pajak SET kd_provinsi='$kd_prov',kd_kota='$kd_kota',kd_jns='$kd_jns',no_reg_wp='$no_reg_wp',nm_reklame='$nm_reklame',alamat_reklame='$alamat_reklame',p=$p,l=$l,s=$s,jlh=$jlh,status_pajak='$status_pajak',ket='$keterangan',penyimpan='$nip',tgl_daftar=TO_DATE('".$arr_data['tgl-daftar']."','DD-MM-YYYY'),tmt_awal=TO_DATE('".$arr_data['tmt-awal']."','DD-MM-YYYY'),tmt_akhir=TO_DATE('".$arr_data['tmt-akhir']."','DD-MM-YYYY'),jenis_penetapan='$jenis_penetapan',kd_tarif=$kd_tarif,lama_pasang=$lama_pasang,status_pemasangan='$status_pemasangan' WHERE kd_kecamatan='$kd_kecamatan' AND kd_kelurahan='$kd_kelurahan' AND kd_obj_pajak='$kd_obj_pajak' AND kd_keg_usaha='$kd_keg_usaha' AND no_reg='$no_reg'";
