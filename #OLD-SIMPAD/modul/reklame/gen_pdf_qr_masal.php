...
$thn_pajak = $_REQUEST['thn_pajak'];
$bln_pajak = $_REQUEST['bln_pajak'];
$a = uniqid();
$nm_file = $a.".pdf";
$pipes = array();
...
$link_pdf = "\"".$base_url."modul/reklame/qr_masal.php?thn=".$thn_pajak."&bln=".$bln_pajak."&bdir=".$base_dir."\"";
$pdf_gen_param = $pdf_gen." --orientation Landscape --page-height 90mm --page-width 50mm --margin-bottom 0 --margin-left 0 --margin-right 0 --margin-top 0 ".$link_pdf;
//$pdf_gen_param = $pdf_gen." --page-size A4 ".$link_pdf;
