...
<table  width="100%" border="0" class="font11 noborder">
 <?php
  ...
  if ($cek == 0 and $jumlah > 0 && $jumlah < 10000000){
              ...
              // echo $outlet_id;
			  ?>
<tr><td colspan="2" align="left"><span class="style9">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbspSILAHKAN PILIH METODE PEMBAYARAN DIBAWAH </span></td></tr>
<tr>
<td width="37%">
 <?php 
				if($data->rc == "00")
...
<tr><td colspan="2">Berdasarkan Peraturan Daerah Nomor 1 Tahun 2024 Tentang Pajak Daerah dan Retribusi Daerah Dilakukan <b> &nbsp;Penyesuaian Tarif Pajak Reklame Menjadi 25% Terhitung 1 Januari 2024</b> </b> </td></tr>
