...
////////
 ...
 $sql_update = "UPDATE REKLAME.SKP A SET va='$va' WHERE A.jns_surat='$jns_surat' AND A.thn_pajak='$thn_pajak' AND A.bln_pajak='$bln_pajak' AND A.kd_obj_pajak='$kd_obj_pajak' AND A.no_urut_surat='$no_urut_skp'";
 $update_va = pg_query($sql_update) or die('Query failed: ' . pg_last_error());
 
 
 if($update_va){
 $sql_va= "SELECT A.VA FROM REKLAME.SKP A WHERE A.jns_surat='$jns_surat' AND A.thn_pajak='$thn_pajak' AND A.bln_pajak='$bln_pajak' AND A.kd_obj_pajak='$kd_obj_pajak' AND A.no_urut_surat='$no_urut_skp'";
...
<table width="100%" border="0" class="noborder">
 <tr><td colspan="3">Berdasarkan Peraturan Daerah Nomor 1 Tahun 2024 Tentang Pajak Daerah dan Retribusi Daerah Dilakukan <b> &nbsp;Penyesuaian Tarif Pajak Reklame Menjadi 25% Terhitung 1 Januari 2024</b> </b> </td></tr>
 <tr><td colspan="3">Apabila SKPD ini tidak atau belum dibayar lewat waktu paling lama 30 hari sejak SKPD diterima akan dikenakan <b>sanksi administrasi berupa bunga sebesar 1% perbulan.</b> </td></tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
