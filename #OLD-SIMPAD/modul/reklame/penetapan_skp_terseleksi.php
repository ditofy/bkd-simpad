...
$(document).ready(function () {
	...
	$('#proses-skp-reklame').click(function(){
		if( $('#nop').val() == '' || $('#npwpd').val() == '' || $('#tarif').val() == null || $('#lama-pasang').val() == '' || $('#tmt-awal').val() == '' || $('#tmt-akhir').val() == '' || $('#tanda-tangan').val() == null || $('#tgl-penetapan').val() == '' ) {
			...
			$("#proses-skp-reklame").attr("disabled", "disabled");
			var inputs = $('#frm-reklame-skp').serializeArray();
					$.post( "modul/reklame/penetapan_p_simpan_skp.php", { postdata: inputs })
  						.done(function( data1 ) {
...
<form id="frm-reklame-skp" name="frm-reklame-skp" data-parsley-validate class="form-horizontal form-label-left">
...
<div class="form-group">
	...
	<div class="form-group">
    	<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
        	<button id="proses-skp-reklame" type="button" class="btn btn-success">Simpan</button>
