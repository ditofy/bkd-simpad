		...
		<div class="x_panel">
			...
			<div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
											...
											<li role="presentation"><a href="#tab_content2" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true" onClick="load_content_tab('update_data.php','')">Update Data</a>
                                            </li>
										...
										<div id="contenttab">
										<?php include_once $_SESSION['base_dir']."modul/reklame/pendaftaran.php"; ?>
										</div>
			</div>
