...
$link_pdf = "\"".$base_url."modul/reklame/skp_masal.php?thn=".$thn_pajak."&bln=".$bln_pajak."&bdir=".$base_dir."\"";
$pdf_gen_param = $pdf_gen." --page-height 285mm --page-width 215mm ".$link_pdf;
