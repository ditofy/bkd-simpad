...
function start_penetapan() {
    ...
    es = new EventSource('/modul/reklame/penetapan_p_penetapan_masal_stpd.php?tahun='+$('#tahun-pajak').val()+'&bulan='+$('#bulan-pajak').val()+'&pejabat='+$('#tanda-tangan').val()+'&tanggal_tetap='+$('#tanggal-penetapan').val());
