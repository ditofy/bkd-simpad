...
$(document).ready(function () {
	$('#cetak').click(function(){
		$('#modal-cnt').html("<center><br><br><img src='images/loading.gif' /><br>Loading<br><br></center>");		
			$.post( "modul/reklame/gen_pdf_stpd.php", { no_stpd: $('#no-stpd').val(), tt: $('#tanda-tangan').val() })
  						.done(function( data1 ) {
	...
	$('#frm-cetak-stpd').submit(function() {
  		return false;
	});
	$("#no-stpd").inputmask();
...
<form id="frm-cetak-stpd" name="frm-cetak-stpd" data-parsley-validate class="form-horizontal form-label-left">
