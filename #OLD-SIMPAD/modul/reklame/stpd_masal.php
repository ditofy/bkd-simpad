...
WHERE A.thn_pajak='$thn' AND A.bln_pajak='$bln' AND A.status_pembayaran < '2'";
$tampil = pg_query($sql) or die('Query failed: ' . pg_last_error());
$n_row = pg_num_rows($tampil);
if($n_row <= 0) {
	echo "STPD BELUM ADA UNTUK TAHUN ".$thn." BULAN ".$bln;
...
<table width="100%" border="0" class="font12 skptablesub">
  <tr>
    <td><br />
<table width="100%" border="0" class="font10 noborder" style="padding-left:5px;padding-top:5px;padding-right:5px;padding-bottom:5px;">
  <tr>
    <td width="21%" class="font12">JENIS PAJAK</td>
    <td width="1%">:</td>
...
<table width="100%" border="0" class="skptablesub">
  ...
  <tr>
    <td colspan="2" class="font12" style="padding-left:20px;padding-bottom:5px;padding-top:5px;padding-right:5px;"><br />
	...
	<tr><td>3.</td><td>Kurang Bayar (1-2)</td><td><strong>Rp.&nbsp;&nbsp;&nbsp;&nbsp;-</strong></td><td></td></tr><tr height="10"><td></td></tr>
  ...
  <tr>
	...
	<table width="100%" border="0" class="noborder">
      ...
      <tr>
        ...
        <td width="97%" align="justify">Harap penyetoran dilakukan melalui Bendahara Penerima Badan Keuangan Daerah Kota Payakumbuh (Kantor Bidang Pendapatan/UPTB Pajak Daerah Jln.Pemuda ex.Lapangan Poliko Kota Payakumbuh) atau ke Kas Daerah pada Bank NAGARI Rek. No : 0100.0101.00201.6  dengan menggunakan Surat Setoran Pajak Daerah (SSPD)</td>
      </tr>
