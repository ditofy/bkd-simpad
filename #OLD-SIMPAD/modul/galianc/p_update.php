...
$query = "UPDATE $schema.dat_obj_pajak SET kd_provinsi='$kd_prov',kd_kota='$kd_kota',kd_jns='$kd_jns',no_reg_wp='$no_reg_wp',nm_usaha='$nm_usaha',alamat_usaha='$alamat_usaha',status_pajak='$status_pajak',ket='$keterangan',penyimpan='$nip',tgl_daftar=TO_DATE('".$arr_data['tgl-daftar']."','DD-MM-YYYY') WHERE kd_kecamatan='$kd_kecamatan' AND kd_kelurahan='$kd_kelurahan' AND kd_obj_pajak='$kd_obj_pajak' AND kd_keg_usaha='$kd_keg_usaha' AND no_reg='$no_reg'";
