...
$(document).ready(function () {
	...
	$('#resetfrm').click(function(){				
				$('#frm-hapus-nop-galianc')[0].reset();
				$("#nop").removeAttr('readonly');				
			});
	$('#proses-hapus-nop-galianc').click(function(){
if($('#nop').val() == ''){
	notif('Notifikasi','Isi NOP','error');			
} else {
	$("#proses-hapus-nop-galianc").attr("disabled", "disabled");
	var inputs = $('#frm-hapus-nop-galianc').serializeArray();
					$.post( "modul/galianc/p_hapus_nop.php", { postdata: inputs })
  						.done(function( data1 ) {
...
<form id="frm-hapus-nop-galianc" name="frm-hapus-nop-galianc" data-parsley-validate class="form-horizontal form-label-left">
...
<div class="form-group">
    <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
       	<button id="proses-hapus-nop-galianc" type="button" class="btn btn-success">Hapus</button>
