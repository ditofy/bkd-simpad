...
<form id="frm-update-nop-galianc" name="frm-update-nop-abt" data-parsley-validate class="form-horizontal form-label-left">
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
		...
		<?php 
			$sql = "SELECT kd_keg_usaha,nm_keg_usaha FROM public.keg_usaha WHERE kd_obj_pajak='08'";
			$tampil = pg_query($sql) or die('Query failed: ' . pg_last_error());
			while ($row = pg_fetch_array($tampil))
			{			
...
<div class="form-group">
    <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
       	<button id="proses-update-nop-galianc" type="button" class="btn btn-success">Proses</button>
