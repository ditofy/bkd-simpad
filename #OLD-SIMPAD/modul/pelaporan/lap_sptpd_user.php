...
function list_data(pg) {
	$('#list-sptpd-user').html("<center><br><br><img src='images/loading.gif' /><br>Loading<br><br></center>");	
	var inputs = $('#filter-data').serializeArray();	
			$.post( "modul/pelaporan/list_sptpd_u_user.php", { postdata: inputs, page: pg })
  						.done(function( data1 ) {
							$('#list-sptpd-user').html(data1);
  					});
};
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>                                           
				<h4 class="modal-title" id="myModalLabel">DATA SPTPD</h4>
			</div>
