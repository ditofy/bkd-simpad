...
function list_data(pg) {
	...
	var inputs = $('#filter-data').serializeArray();	
			$.post( "modul/pelaporan/list_stpd.php", { postdata: inputs, page: pg })
  						.done(function( data1 ) {
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>                                           
				<h4 class="modal-title" id="myModalLabel">DATA STPD</h4>
			</div>
...
<form id="filter-data" name="filter-data">
  ...
  <tr>
    <td style="vertical-align:middle" align="right">NO. STPD </td>
    <td><input type="text" id="no-surat" name="no-surat" class="form-control col-md-7 col-xs-12" placeholder="Nomor STPD" data-inputmask="'mask': '99.9999.99.99.9999'"></td>
  ...
  while($thn >= '2017') {
   ...
   ?>
    ...
    <td style="vertical-align:middle" align="right">Bulan STPD</td>
