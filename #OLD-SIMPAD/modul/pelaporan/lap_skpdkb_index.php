...
function list_data(pg) {
	$('#list-restoran-skpdkb').html("<center><br><br><img src='images/loading.gif' /><br>Loading<br><br></center>");	
	var inputs = $('#filter-data').serializeArray();	
			$.post( "modul/pelaporan/list_skpdkb.php", { postdata: inputs, page: pg })
  						.done(function( data1 ) {
							$('#list-restoran-skpdkb').html(data1);
  					});
};
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>                                           
				<h4 class="modal-title" id="myModalLabel">DATA SKPDKB</h4>
			</div>
...
<form id="filter-data" name="filter-data">
  ...
  <tr>
    <td style="vertical-align:middle" align="right">NO. SKPDKB </td>
    <td><input type="text" id="no-surat" name="no-surat" class="form-control col-md-7 col-xs-12" placeholder="Nomor SKPDKB" data-inputmask="'mask': '99.9999.99.99.9999'"></td>
  ...
  <tr>
    ...
    <td><select name="kd-obj-pajak" id="kd-obj-pajak" class="select2_single" style="width:150px;" onchange="get_keg_usaha($('#kd-obj-pajak').val());">
		...
		<option value="04">Pajak PPJ</option>
