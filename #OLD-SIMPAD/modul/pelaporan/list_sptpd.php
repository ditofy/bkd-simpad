...
$(document).ready(function () {
	...
	$('#download-excell').click(function(){		
    		...
    		window.open('/print/list_sptpd_xls.php');
			});	
	});
...
<button id="download-excell" type="button" class="btn btn-dark">Download XLS</button>
...
?>                                        
                                            <tr class="even pointer">
												...
												?>
												<button onclick="JavaScript:window.location.href='https://sptpd.payakumbuhkota.go.id/dokumen/pendukung/<?php echo $row['dokumen']; ?>';">Lihat</button>
