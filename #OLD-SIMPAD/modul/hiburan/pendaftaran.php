...
$(document).ready(function () {
			...
			$('#proses-daftar-hiburan').click(function(){
if($('#npwpd').val() == '' || $('#kd-kecamatan').val() == null || $('#kd-kelurahan').val() == null || $('#kd-keg-usaha').val() == null || $('#nama-usaha').val() == '' || $('#alamat-usaha').val() == '' || $('#jenis-penetapan').val() == null || $('#tgl-daftar').val() == ''){
	...
	$("#proses-daftar-hiburan").attr("disabled", "disabled");
	var inputs = $('#frm-daftar-hiburan').serializeArray();
					$.post( "modul/hiburan/p_tambah.php", { postdata: inputs })
  						.done(function( data1 ) {
   							notif('Notifikasi',data1,'success');
							$('#resetfrm').click();
							$("#proses-daftar-abt").removeAttr('disabled');
  					});
}	
});
...
<form id="frm-daftar-hiburan" name="frm-daftar-hiburan" data-parsley-validate class="form-horizontal form-label-left">
	...
	<div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
        	<input type="text" id="kd-obj-pajak" name="kd-obj-pajak" required="required" class="form-control col-md-7 col-xs-12" readonly="readonly" value="06 - HIBURAN">
        </div>
	</div>
	<div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
			...
			<?php 
			$sql = "SELECT kd_keg_usaha||' - '||nm_keg_usaha AS value FROM public.keg_usaha WHERE kd_obj_pajak='06' ORDER BY kd_keg_usaha";
			$tampil = pg_query($sql) or die('Query failed: ' . pg_last_error());
			while ($row = pg_fetch_array($tampil))
			{
	...
	<div class="form-group">
    	...
    	<div class="col-md-6 col-sm-6 col-xs-12">
    		<select name="jenis-penetapan" id="jenis-penetapan" class="select2_single" style="width:200px">
				...
				<option value="02 - BILL">02 - SELF ASSESMENT</option>
			</select>
    	</div>
    </div>
	<div class="form-group">
	...
	<div class="form-group">
    	<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
        	<button id="proses-daftar-hiburan" type="button" class="btn btn-success">Simpan</button>
