...
$(document).ready(function () {
			...
			$('#proses-update-hiburan').click(function(){
if($('#nop').val() == '' || $('#npwpd').val() == '' || $('#nama-usaha').val() == '' || $('#alamat-usaha').val() == '' || $('#tgl-daftar').val() == '' || $("#status-pajak").val() == null || $("#jenis-penetapan").val() == null ){
	...
	$("#proses-update-hiburan").attr("disabled", "disabled");
	var inputs = $('#frm-update-hiburan').serializeArray();
					$.post( "modul/hiburan/p_update.php", { postdata: inputs })
  						.done(function( data1 ) {
   							notif('Notifikasi',data1,'success');
							$('#reset').click();
							$("#proses-update-hiburan").removeAttr('disabled');
  					});
}	
});
			$("#jenis-penetapan").select2("val", "");
...
<form id="frm-update-hiburan" name="frm-update-hiburan" data-parsley-validate class="form-horizontal form-label-left">
	...
	<div class="form-group">
    	<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
        	<button id="proses-update-hiburan" type="button" class="btn btn-success">Update</button>
