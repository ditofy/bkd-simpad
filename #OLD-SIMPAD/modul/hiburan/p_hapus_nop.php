...
pg_free_result($exec_cek);
if( ($skp > 0) or ($sptpd > 0) ) {
	echo "ERROR, Objek Pajak dengan NOP : ".$kd_kecamatan.".".$kd_kelurahan.".".$kd_obj_pajak.".".$kd_keg_usaha.".".$no_reg." Sudah Pernah Diterbitkan SKP atau SPTPD, Silahkan Non Aktifkan Status Pajak";
} else {
