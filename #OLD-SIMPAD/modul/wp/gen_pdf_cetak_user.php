...
$cwd = "/home/simpad-new/public_html/tmp_u_sptpd/";
...
$link_pdf = "\"".$base_url."modul/wp/cetak_user.php?npwpd=".$npwpd."&bdir=".$base_dir."&nama=".$nama."&pass=".$pass."\"";
...
echo $base_url."tmp_u_sptpd/".$nm_file;
?>
