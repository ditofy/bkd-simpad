...
function list_data(pg) {
	...
	var inputs = $('#filter-data').serializeArray();	
			$.post( "modul/restoran/list.php", { postdata: inputs, page: pg })
  						.done(function( data1 ) {
...
<form id="filter-data" name="filter-data">
  ...
  <tr>
    ...
    <td>
		...
		<?php 
			$sql = "SELECT kd_keg_usaha,nm_keg_usaha FROM public.keg_usaha WHERE kd_obj_pajak='03'";
  ...
  <tr>
    ...
    <td style="vertical-align:middle" align="right">Jenis Penetapan</td>
