...
$(document).ready(function () {
			...
			$('#proses-update-resto').click(function(){
if($('#nop').val() == '' || $('#npwpd').val() == '' || $('#nama-usaha').val() == '' || $('#alamat-usaha').val() == '' || $('#jenis-penetapan').val() == null || $('#tgl-daftar').val() == '' || $("#status-pajak").val() == null ){
	notif('Notifikasi','Isi Semua Data','error');			
} else {
	$("#proses-update-resto").attr("disabled", "disabled");
	var inputs = $('#frm-update-resto').serializeArray();
					$.post( "modul/restoran/p_update.php", { postdata: inputs })
  						.done(function( data1 ) {
   							notif('Notifikasi',data1,'success');
							$('#reset').click();
							$("#proses-update-resto").removeAttr('disabled');
  					});
}	
});
...
<form id="frm-update-resto" name="frm-daftar-resto" data-parsley-validate class="form-horizontal form-label-left">
	...
	<div class="form-group">
    	...
    	<div class="col-md-6 col-sm-6 col-xs-12">
    		<select name="jenis-penetapan" id="jenis-penetapan" class="select2_single" style="width:250px">
				<option value="01">01 - WARALABA</option>
				<option value="02">02 - NON WARALABA</option>
				<option value="03">03 - DATA LAMA</option>
			</select>
    	</div>
    </div>
	...
	<div class="form-group">
    	<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
        	<button id="proses-update-resto" type="button" class="btn btn-success">Update</button>
