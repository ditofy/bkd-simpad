...
include_once $_SESSION['base_dir']."inc/db.inc.php";
	...
	$sql = "SELECT kd_kecamatan||'.'||kd_kelurahan||'.'||kd_obj_pajak||'.'||kd_keg_usaha||'.'||no_reg as value,id FROM $schema.dat_obj_pajak WHERE kd_kecamatan||'.'||kd_kelurahan||'.'||kd_obj_pajak||'.'||kd_keg_usaha||'.'||no_reg LIKE '%$filter%' AND status_pajak='1' LIMIT 10";
