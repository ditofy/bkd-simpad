...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
				<h2>Data PLN Berdasarkan KWH</h2>
			<div class="x_title">
			</div>
...
<button type="button" class="btn btn-success" id="submit-tampilkan-kwh">Tampilkan Data KWH PLN</button>
</td>
</tr>
</table>
		<div class="col-md-12 col-sm-3 col-xs-12 bg-white" id="data-kwh">		
...
function get_kel(kd) {
	if(kd != ""){
        ...
        $(document).ready(function () {
			...
			$('#submit-tampilkan-kwh').click(function(){
					if($('#kd-kecamatan').val() != '') {
						$('#data-kwh').html("<img src='images/loading.gif' />");
						$("#submit-tampilkan-kwh").attr("disabled", "disabled");
						$.post( "modul/ppj/cari_kwh.php", { kd_kecamatan: $('#kd-kecamatan').val(), kd_kelurahan: $('#kd-kelurahan').val()})
  						.done(function( data ) {
   						$('#data-kwh').html(data);
							$("#submit-tampilkan-kwh").removeAttr('disabled');
  						});
					} else {
