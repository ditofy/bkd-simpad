...
function list_data(pg) {
	$('#list-ppj').html("<center><br><br><img src='images/loading.gif' /><br>Loading<br><br></center>");	
	var inputs = $('#filter-data').serializeArray();	
			$.post( "modul/ppj/list.php", { postdata: inputs, page: pg })
  						.done(function( data1 ) {
							$('#list-ppj').html(data1);
  					});
};
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>                                           
				<h4 class="modal-title" id="myModalLabel">DATA PPJ</h4>
			</div>
...
<form id="filter-data" name="filter-data">
  ...
  <tr>
    ...
    <td>
		...
		<?php 
			$sql = "SELECT kd_keg_usaha,nm_keg_usaha FROM public.keg_usaha WHERE kd_obj_pajak='04'";
