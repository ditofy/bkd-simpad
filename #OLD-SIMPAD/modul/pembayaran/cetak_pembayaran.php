...
$no_surat = pg_escape_string($_GET['no_bayar']);
...
switch ($table) {
	case "SKP":
		if($schema == 'reklame') {
			...
			$sql = "SELECT A.kd_kecamatan||'.'||A.kd_kelurahan||'.'||A.kd_obj_pajak||'.'||A.kd_keg_usaha||'.'||A.no_reg AS nop,A.kd_provinsi||'.'||A.kd_kota||'.'||A.kd_jns||'.'||A.no_reg_wp AS npwpd,A.nm_usaha AS nm_objek,A.pokok_pajak,A.status_pembayaran,0 AS denda,B.nama,C.nm_obj_pajak,D.tgl_bayar  FROM $schema.$table A INNER JOIN public.wp B ON B.kd_provinsi=A.kd_provinsi AND B.kd_kota=A.kd_kota AND B.kd_jns=A.kd_jns AND B.no_reg=A.no_reg_wp INNER JOIN public.obj_pajak C ON c.kd_obj_pajak=A.kd_obj_pajak LEFT JOIN $schema.pembayaran D ON A.jns_surat=D.jns_surat AND A.thn_pajak=D.thn_pajak AND A.bln_pajak=D.bln_pajak AND A.kd_obj_pajak=D.kd_obj_pajak AND A.no_urut_surat=D.no_urut_surat  WHERE A.jns_surat='$kd_jns_surat' AND A.thn_pajak='$thn_pajak' AND A.bln_pajak='$bln_pajak' AND A.kd_obj_pajak='$kd_obj_pajak' AND A.no_urut_surat='$no_urut_surat'";
			
			
		}
		break;
	case "SPTPD":
		$sql = "SELECT A.kd_kecamatan||'.'||A.kd_kelurahan||'.'||A.kd_obj_pajak||'.'||A.kd_keg_usaha||'.'||A.no_reg AS nop,A.kd_provinsi||'.'||A.kd_kota||'.'||A.kd_jns||'.'||A.no_reg_wp AS npwpd,A.nm_usaha AS nm_objek,A.pokok_pajak,A.status_pembayaran,0 AS denda,B.nama,C.nm_obj_pajak,A.alamat_usaha as alamat_obj,B.alamat as alamat_wp,D.tgl_bayar FROM $schema.$table A INNER JOIN public.wp B ON B.kd_provinsi=A.kd_provinsi AND B.kd_kota=A.kd_kota AND B.kd_jns=A.kd_jns AND B.no_reg=A.no_reg_wp INNER JOIN public.obj_pajak C ON c.kd_obj_pajak=A.kd_obj_pajak LEFT JOIN $schema.pembayaran D ON A.jns_surat=D.jns_surat AND A.thn_pajak=D.thn_pajak AND A.bln_pajak=D.bln_pajak AND A.kd_obj_pajak=D.kd_obj_pajak AND A.no_urut_surat=D.no_urut_surat WHERE A.jns_surat='$kd_jns_surat' AND A.thn_pajak='$thn_pajak' AND A.bln_pajak='$bln_pajak' AND A.kd_obj_pajak='$kd_obj_pajak' AND A.no_urut_surat='$no_urut_surat'";
		break;
		case "SSPD":
		$sql = "SELECT A.kd_kecamatan||'.'||A.kd_kelurahan||'.'||A.kd_obj_pajak||'.'||A.kd_keg_usaha||'.'||A.no_reg AS nop,A.kd_provinsi||'.'||A.kd_kota||'.'||A.kd_jns||'.'||A.no_reg_wp AS npwpd,A.nm_usaha AS nm_objek,A.pokok_pajak,A.status_pembayaran,0 AS denda,B.nama,C.nm_obj_pajak,A.alamat_usaha as alamat_obj,B.alamat as alamat_wp,D.tgl_bayar FROM $schema.$table A INNER JOIN public.wp B ON B.nik=A.nik INNER JOIN public.obj_pajak C ON c.kd_obj_pajak=A.kd_obj_pajak LEFT JOIN $schema.pembayaran D ON A.jns_surat=D.jns_surat AND A.thn_pajak=D.thn_pajak AND A.bln_pajak=D.bln_pajak AND A.kd_obj_pajak=D.kd_obj_pajak AND A.no_urut_surat=D.no_urut_surat WHERE A.jns_surat='$kd_jns_surat' AND A.thn_pajak='$thn_pajak' AND A.bln_pajak='$bln_pajak' AND A.kd_obj_pajak='$kd_obj_pajak' AND A.no_urut_surat='$no_urut_surat'";
		break;
		case "SKPDKB":
...
<?php QRcode::png("$qrcode","image.png","L",2,2);echo "<img src='image.png'/>";?>
  ...
  <tr height="50">
    <td colspan="4" align="center" ><span class="font16">CATATAN PEMBAYARAN PAJAK DAERAH </span></td>
    </tr>
...
<tr><td width="1%"></td><td>&nbsp;</td><td width="20%"></td><td>&nbsp;</td><td colspan="2">&nbsp;</td></tr>
<tr><td width="1%"></td><td>&nbsp;</td><td width="20%">3. Nama Objek</td><td>&nbsp;:</td><td colspan="2"><?php echo $row['nm_objek'];?></td></tr>
<tr><td width="1%"></td><td>&nbsp;</td><td width="20%"></td><td>&nbsp;</td><td colspan="2">&nbsp;</td></tr>
<tr><td width="1%"></td><td>&nbsp;</td><td width="20%">4. Alamat Objek Pajak</td><td>&nbsp;:</td><td align="left" colspan="2"><?php echo $row['alamat_obj']; ?></td></tr>
<tr><td width="1%"></td><td>&nbsp;</td><td width="20%"></td><td>&nbsp;</td><td colspan="2">&nbsp;</td></tr>
<tr><td width="1%"></td><td>&nbsp;</td><td width="20%">5. Nama Wajib Pajak</td><td>&nbsp;:</td><td colspan="2"><?php echo $row['nama'];?></td></tr>
<tr><td width="1%"></td><td>&nbsp;</td><td width="20%"></td><td>&nbsp;</td><td colspan="2">&nbsp;</td></tr>
<tr><td width="1%"></td><td>&nbsp;</td><td width="20%">6. NPWPD</td><td>&nbsp;:</td><td align="left" colspan="2"><?php echo $row['npwpd']; ?></td></tr>
<tr><td width="1%"></td><td>&nbsp;</td><td width="20%"></td><td>&nbsp;</td><td colspan="2">&nbsp;</td></tr>
<tr><td width="1%"></td><td>&nbsp;</td><td width="20%">7. Alamat Wajib Pajak</td><td>&nbsp;:</td><td align="left" colspan="2"><?php echo $row['alamat_wp']; ?></td></tr>
<tr><td width="1%"></td><td>&nbsp;</td><td width="20%"></td><td>&nbsp;</td><td colspan="2">&nbsp;</td></tr>
<tr><td width="1%"></td><td>&nbsp;</td><td width="20%">8. Pokok Pajak</td><td>&nbsp;:</td><td align="left" colspan="2">Rp.&nbsp;<?php echo number_format($row['pokok_pajak']);?>&nbsp;,-</td></tr>
<tr><td width="1%"></td><td>&nbsp;</td><td width="20%"></td><td>&nbsp;</td><td colspan="2">&nbsp;</td></tr>
<tr><td width="1%"></td><td>&nbsp;</td><td width="20%">9. Dengan Huruf</td><td>&nbsp;:</td><td align="left" colspan="2"><?php echo "<strong><i>".terbilang($row['pokok_pajak'], $style=3)." Rupiah </i></strong>";?>&nbsp;,-</td></tr>
<tr><td width="1%"></td><td>&nbsp;</td><td width="20%"></td><td>&nbsp;</td><td colspan="2">&nbsp;</td></tr>
<tr><td width="1%"></td><td>&nbsp;</td><td width="20%">10. Tanggal Bayar</td><td>&nbsp;:</td><td align="left" colspan="2"><?php 
if($row['tgl_bayar'] != ""){
...
<tr><td width="1%"></td><td>&nbsp;</td><td width="20%"></td><td>&nbsp;</td><td colspan="2">&nbsp;</td></tr>
<tr><td width="1%"></td><td>&nbsp;</td><td width="20%">11. Status Pembayaran</td><td>&nbsp;:</td><td align="left" colspan="2">
