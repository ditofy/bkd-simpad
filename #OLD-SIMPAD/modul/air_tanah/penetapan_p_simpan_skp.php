...
if($ada_data > 0) {
	...
	deleteVaPjd($nops);
	$va = getVaPjd($nops, $nm_usaha, $pokok_pajak);
	pg_free_result($result);
	$query_input = "INSERT INTO 	$schema.skp(thn_pajak,bln_pajak,no_urut_surat,kd_kecamatan,kd_kelurahan,kd_obj_pajak,kd_keg_usaha,no_reg,kd_provinsi,kd_kota,kd_jns,no_reg_wp,nm_usaha,alamat_usaha,pokok_pajak,penyimpan,tgl_simpan,status_pembayaran,tgl_penetapan,nip_pejabat,tgl_jatuh_tempo,va) VALUES('$thn_pajak','$bln_pajak','$no_urut_skp','$kd_kecamatan','$kd_kelurahan','$kd_obj_pajak','$kd_keg_usaha','$no_reg','13','76','$kd_jns','$no_reg_wp','$nm_usaha','$alamat_usaha',$pokok_pajak,'$nip',TO_DATE('$today','DD-MM-YYYY'),'0',TO_DATE('$tgl_penetapan','DD-MM-YYYY'),'$pejabat',TO_DATE('$tgl_jatuh_tempo','DD-MM-YYYY'),$va)";
