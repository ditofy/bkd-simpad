...
function list_data(pg) {
	$('#list-abt').html("<center><br><br><img src='images/loading.gif' /><br>Loading<br><br></center>");	
	var inputs = $('#filter-data').serializeArray();	
			$.post( "modul/air_tanah/list.php", { postdata: inputs, page: pg })
  						.done(function( data1 ) {
							$('#list-abt').html(data1);
  					});
};
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>                                           
				<h4 class="modal-title" id="myModalLabel">DATA ABT</h4>
			</div>
...
<form id="filter-data" name="filter-data">
  ...
  <tr>
    ...
    <td>
		<select name="keg-usaha" id="keg-usaha" class="select2_single">
		<?php 
  ...
  <tr>
    ...
    <td style="vertical-align:middle" align="right">Status</td>
    <td><select name="jenis-penetapan" id="jenis-penetapan" class="select2_single" style="width:230px">
