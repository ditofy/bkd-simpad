...
$(document).ready(function () {
			...
			$('#proses-daftar-abt').click(function(){
if($('#npwpd').val() == '' || $('#kd-kecamatan').val() == null || $('#kd-kelurahan').val() == null || $('#kd-keg-usaha').val() == null || $('#nama-usaha').val() == '' || $('#alamat-usaha').val() == '' || $('#jenis-penetapan').val() == null || $('#tgl-daftar').val() == ''){
	...
	$("#proses-daftar-abt").attr("disabled", "disabled");
	var inputs = $('#frm-daftar-abt').serializeArray();
					$.post( "modul/air_tanah/p_tambah.php", { postdata: inputs })
  						.done(function( data1 ) {
...
<form id="frm-daftar-abt" name="frm-daftar-abt" data-parsley-validate class="form-horizontal form-label-left">
	...
	<div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
        	<input type="text" id="kd-obj-pajak" name="kd-obj-pajak" required="required" class="form-control col-md-7 col-xs-12" readonly="readonly" value="01 - AIR TANAH">
        </div>
	</div>
	<div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
			...
			<?php 
			$sql = "SELECT kd_keg_usaha||' - '||nm_keg_usaha AS value FROM public.keg_usaha WHERE kd_obj_pajak='01'";
			$tampil = pg_query($sql) or die('Query failed: ' . pg_last_error());
			while ($row = pg_fetch_array($tampil))
			{
	...
	<div class="form-group">
    	<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
        	<button id="proses-daftar-abt" type="button" class="btn btn-success">Simpan</button>
