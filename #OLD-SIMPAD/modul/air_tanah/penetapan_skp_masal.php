...
function start_penetapan() {
    ...
    es = new EventSource('/modul/air_tanah/penetapan_p_penetapan_masal_skp.php?tahun='+$('#tahun-pajak').val()+'&bulan='+$('#bulan-pajak').val()+'&pejabat='+$('#tanda-tangan').val()+'&tanggal_tetap='+$('#tanggal-penetapan').val());
...
$(document).ready(function () {
	...
	$('#cetak').click(function(){
		$('#modal-cnt').html("<center><br><br><img src='images/loading.gif' /><br>Loading<br><br></center>");		
			$.post( "modul/air_tanah/gen_pdf_skp_masal.php", { thn_pajak: $('#tahun-pajak').val(), bln_pajak: $('#bulan-pajak').val() })
  						.done(function( data1 ) {
