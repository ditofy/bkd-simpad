...
$sql = "SELECT A.*,B.nama,B.alamat,C.rek_apbd,C.outlet_id FROM air_tanah.skp A INNER JOIN public.wp B ON
...
WHERE A.jns_surat='$jns_surat' AND A.thn_pajak='$thn_pajak' AND A.bln_pajak='$bln_pajak' AND A.kd_obj_pajak='$kd_obj_pajak' AND A.no_urut_surat='$no_urut_skp'";
...
<table width="100%" border="0" class="noborder" style="padding-left:5px;padding-top:5px;padding-right:5px;padding-bottom:5px;">
  ...
  <tr>
    ...
    <td><?php 
	//	if($row['bln_pajak'] == '01') { 
			  	echo $bulan_s[$row['bln_pajak']]." ".($row['thn_pajak']);
			 // } else {
