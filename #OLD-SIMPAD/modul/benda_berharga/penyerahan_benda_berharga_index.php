...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
				...
				<h2>Penyerahan Benda Berharga</h2>
			<div class="x_title">
			</div>
			<div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true" onClick="load_content_tab_bill('penyerahan_bill.php','')">Penyerahan Bill</a>
                                            </li>											
										...
										<div id="contenttab">
										<?php include_once $_SESSION['base_dir']."modul/benda_berharga/penyerahan_benda_berharga.php"; ?>
										</div>
			</div>
