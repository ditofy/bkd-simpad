...
$(document).ready(function () {
	...
	$('#cetak-sspd').click(function(){
		$('#modal-cnt').html("<center><br><br><img src='images/loading.gif' /><br>Loading<br><br></center>");		
			$.post( "modul/parkir/gen_pdf_sspd.php", { no_sptpd: $('#no-sptpd').val() })
  						.done(function( data1 ) {
							$('#modal-cnt').html("<object type='application/pdf' data='"+data1+"' width='100%' height='500'>this is not working as expected</object>");
  					});
	});
	...
	$('#nop').autocomplete({
				...
				$.ajax({
                	type: "GET",
                	url: "modul/parkir/get_detail_objek.php",
	...
	$('#proses-sptpd-restoran').click(function(){
		if( $('#nop').val() == '' || $('#npwpd').val() == '' || $('#tarif').val() == null || $('#dasar-pengenaan-pajak').val() == '' || $('#tanggal-penyampaian').val() == '' ) {
			...
			var inputs = $('#frm-restoran-sptpd').serializeArray();
					$.post( "modul/parkir/penyampaian_p_simpan_sptpd.php", { postdata: inputs })
  						.done(function( data1 ) {
...
<div class="form-group">
	<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Jenis PBJT</label>
    <div class="col-md-6 col-sm-6 col-xs-12">
    	<select name="jenis-pajak" id="jenis-pajak" class="select2_single" style="width:200px">
			<option value="05" selected="selected">PAJAK PARKIR</option>
...
<div class="form-group">
	<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Roda Dua</label>
    	<div class="col-md-3 col-sm-6 col-xs-12">
    		<input type="text" id="dasar-pengenaan-pajak" name="dasar-pengenaan-pajak-dua" class="form-control col-md-7 col-xs-12" placeholder="Dasar Pengenaan Pajak Roda Dua">
    	</div>
</div>
<div class="form-group">
	<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Roda Empat</label>
    	<div class="col-md-3 col-sm-6 col-xs-12">
    		<input type="text" id="dasar-pengenaan-pajak" name="dasar-pengenaan-pajak-empat" class="form-control col-md-7 col-xs-12" placeholder="Dasar Pengenaan Pajak Roda Empat">
    	</div>
</div>
<div class="form-group">
