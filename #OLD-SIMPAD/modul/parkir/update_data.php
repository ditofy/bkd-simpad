...
$(document).ready(function () {
			...
			$('#proses-update-parkir').click(function(){
if($('#nop').val() == '' || $('#npwpd').val() == '' || $('#nama-usaha').val() == '' || $('#alamat-usaha').val() == '' || $('#tgl-daftar').val() == '' || $("#status-pajak").val() == null ){
	...
	$("#proses-update-parkir").attr("disabled", "disabled");
	var inputs = $('#frm-update-parkir').serializeArray();
					$.post( "modul/parkir/p_update.php", { postdata: inputs })
  						.done(function( data1 ) {
   							notif('Notifikasi',data1,'success');
							$('#reset').click();
							$("#proses-update-parkir").removeAttr('disabled');
  					});
}	
});
...
<form id="frm-update-parkir" name="frm-update-parkir" data-parsley-validate class="form-horizontal form-label-left">
	...
	<div class="form-group">
    	<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
        	<button id="proses-update-parkir" type="button" class="btn btn-success">Update</button>
