...
<table width="100%" border="0" class="skptablesub">
  <tr>
    <td colspan="2" class="font11" style="padding-left:20px;padding-bottom:5px;padding-top:5px;padding-right:20px;">
		<b>KELAS/GOLONGAN DAN TARIF</b><br/><br/>
		<table width="100%" class="garis font11">
		<tr>
		<td rowspan="2">No</td><td rowspan="2" align="center">Jenis Kenderaan</td><td align="center" colspan="2">Jenis Tarif</td>
		</tr>
		<tr>
		<td align="center" >1 X PARKIR</td><td align="center" >PARKIR NGINAP</td>
		</tr>
		<tr>
		<td>1</td><td>&nbsp;RODA 4</td><td>&nbsp;Rp</td><td>&nbsp;Rp</td>
		</tr>
		<tr>
		<td>2</td><td>&nbsp;RODA 2</td><td>&nbsp;Rp</td><td>&nbsp;Rp</td>
		</tr>
		<tr>
		<td>3</td><td>&nbsp;...........</td><td>&nbsp;Rp</td><td>&nbsp;Rp</td>
		</tr>
		<tr>
		...
		<br/>
		  ...
		  <b>JUMLAH PAJAK DAERAH YANG DILAPORKAN</b><br /><br />
		<table width="100%" border="0" class="garis font11">
		<tr><td align="center">URAIAN</td><td align="center">S/D BULAN LALU(Rp)</td><td align="center">BULAN INI(Rp)</td><td align="center">S/D BULAN INI(Rp)</td></tr>
		<tr><td>RODA 4</td><td>&nbsp;</td><td align="center">&nbsp;<?php echo number_format($row['roda_empat']); ?></td><td align="center">&nbsp;</td></tr>
		
		<tr><td>RODA 2</td><td>&nbsp;</td><td align="center">&nbsp;<?php echo number_format($row['roda_dua']); ?></td><td>&nbsp;</td></tr>
		<tr><td>RODA 4 PARKIR NGINAP</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
		<tr><td>..........................</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
			</table>
			<table class="font12"  width="100%">
		<tr><td align="center"><b>TOTAL PENERIMAAN</b></td><td><b>&nbsp;Rp&nbsp;&nbsp;</b></td><td><b><?php echo number_format($row['dasar_pengenaan_pajak']); ?></b></td></tr>
		<tr><td align="center"><b>PAJAK TERUTANG (20%) DARI TOTAL PENERIMAAN</b></td><td><b>&nbsp;Rp&nbsp;&nbsp;</b></td><td><b><?php echo number_format($row['pokok_pajak']); ?></b></td></tr>
		</table>
		<br />
		<b>C. DATA PENDUKUNG</b><br/><br/>	
