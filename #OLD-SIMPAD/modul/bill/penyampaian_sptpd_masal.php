...
function start_penetapan() {
	if( $('#tahun-pajak').val() == null || $('#bulan-pajak').val() == null || $('#tanggal-penetapan').val() == '' ) {
    ...
    es = new EventSource('/modul/bill/p_penyampaian_masal_sptpd.php?tahun='+$('#tahun-pajak').val()+'&bulan='+$('#bulan-pajak').val()+'&tanggal_tetap='+$('#tanggal-penetapan').val());
...
$(document).ready(function () {
	...
	$('#cetak').click(function(){
		$('#modal-cnt').html("<center><br><br><img src='images/loading.gif' /><br>Loading<br><br></center>");		
			$.post( "modul/bill/gen_pdf_sptpd_masal.php", { thn_pajak: $('#tahun-pajak').val(), bln_pajak: $('#bulan-pajak').val() })
  						.done(function( data1 ) {
...
<div class="form-group">
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
        	<input type="text" id="tanggal-penetapan" name="tanggal-penetapan" class="form-control has-feedback-left" placeholder="Tanggal Penyampaian" aria-describedby="inputSuccess2Status" data-inputmask="'mask': '99-99-9999'">
