			...
			<div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            ...
                                            <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab"  aria-expanded="true" onClick="load_content_tab('list_index.php','')">List Data</a>
											 ...
											 <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab"  aria-expanded="true" onClick="load_content_tab('detail_index.php','')">Detail Data</a>
                                            </li>
										...
										<div id="contenttab">
										<?php include_once $_SESSION['base_dir']."modul/hotel/pendaftaran.php"; ?>
										</div>
			</div>
