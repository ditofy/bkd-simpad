...
$(document).ready(function () {
			...
			$('#proses-daftar-hotel').click(function(){
if($('#npwpd').val() == '' || $('#kd-kecamatan').val() == null || $('#kd-kelurahan').val() == null || $('#kd-keg-usaha').val() == null || $('#nama-usaha').val() == '' || $('#alamat-usaha').val() == '' || $('#tgl-daftar').val() == ''){
	...
	$("#proses-daftar-hotel").attr("disabled", "disabled");
	var inputs = $('#frm-daftar-hotel').serializeArray();
					$.post( "modul/hotel/p_tambah.php", { postdata: inputs })
  						.done(function( data1 ) {
   							notif('Notifikasi',data1,'success');
							$('#resetfrm').click();
							$("#proses-daftar-hotel").removeAttr('disabled');
  					});
}	
});
...
<form id="frm-daftar-hotel" name="frm-daftar-hotel" data-parsley-validate class="form-horizontal form-label-left">
	...
	<div class="form-group">
    	<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
        	<button id="proses-daftar-hotel" type="button" class="btn btn-success">Simpan</button>
