...
$sql = "SELECT A.kd_kecamatan||'.'||A.kd_kelurahan||'.'||A.kd_obj_pajak||'.'||A.kd_keg_usaha||'.'||A.no_reg as NOP,A.bln_pajak,A.thn_pajak,A.tgl_surat, C.kd_provinsi||'.'||C.kd_kota||'.'||C.kd_jns||'.'||C.no_reg as npwpd,B.alamat_usaha,B.nm_usaha,D.nm_obj_pajak,D.perda,A.nip_p FROM hotel.teguran_sptpd A INNER JOIN hotel.dat_obj_pajak B ON
...
$bulan_berikut=no_reg($row['bln_pajak']+1);
$fu=$bulan_s[$bulan_berikut];
$qrcode=$row['qrcode'];
...
<div style="width:100%;height:300mm;">
  ...
  <td width="20"><img src="../../images/payakumbuh.png" height="60"></td>  <td height="50" align="center"><span class="style1">PEMERINTAH DAERAH KOTA PAYAKUMBUH</span><br/>
    ...
    <span class="style3">Jln. Veteran No. 70 Kel. Kapalo Koto Dibalai Kec. Payakumbuh Utara Payakumbuh </span></br>
	 <span class="style3">Telepon / Fax (0752) 93279 Payakumbuh - 25211</span></td>
    </tr>
...
<table width="100%" border="0" class="noborder" style="padding-left:5px;padding-top:5px;padding-right:5px;padding-bottom:5px;">
  <tr>
    <td width="7%">Nomor</td>
    <td width="1%">:</td>
    <td width="32%">900/<?php echo $row['bln_pajak']."/&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;".$row['no_urut_surat']."/BKD-PYK/".$row['thn_pajak']."";?></td>
	<td width="50%" align="center" rowspan="4">
	<?php // echo "Payakumbuh,  &nbsp;&nbsp;&nbsp;   Juni 2019" ; ?><?php echo "Payakumbuh, ".date('d',strtotime($row['tgl_surat']))." ".$bulan[date('n',strtotime($row['tgl_surat']))]." ".date('Y',strtotime($row['tgl_surat'])); ?><br/><div align="center" style="margin-left:60px;">Kepada Yth: <br/></div>
...
<table width="100%" border="0" class="noborder" style="padding-left:5px;padding-top:5px;padding-right:5px;padding-bottom:5px;">
  ...
  <tr height="20"><td></td></tr>
	<tr><td align="justify"><div style="margin-left:80px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Berdasarkan hal tersebut diatas, diberitahukan kepada saudara agar segera menyampaikan SPTPD beserta data pendukung yang lengkap dan benar untuk bulan&nbsp;<b><?php echo $bulan_s[$row['bln_pajak']];?>&nbsp;Tahun<b> <?php echo $row['thn_pajak'];?> </b>&nbsp;paling lambat tanggal 15 (lima belas) bulan <b><?php echo $fu;?>&nbsp; <?php echo $row['thn_pajak'];?></b></div></td></tr>
	<tr height="20"><td></td></tr>
	<tr><td align="justify"><div style="margin-left:80px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Apabila SPTPD tidak disampaikan dalam jangka waktu sebagaimana dimaksud diatas, Wajib Pajak akan dikenakan sanksi administratif berupa bunga sebesar 2% (dua persen) sebulan dihitung dari Pajak yang kurang atau terlambat dibayar untuk jangka waktu paling lama 24(dua puluh empat) bulan dihitung sejak saat terutangnya Pajak.</div></td></tr>
	<tr height="20"><td></td></tr>
