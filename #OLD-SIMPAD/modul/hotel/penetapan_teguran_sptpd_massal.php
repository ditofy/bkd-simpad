...
function start_penetapan() {
    ...
    es = new EventSource('/modul/hotel/penetapan_p_teguran_sptpd_massal.php?tahun='+$('#tahun-pajak').val()+'&bulan='+$('#bulan-pajak').val()+'&pejabat='+$('#tanda-tangan').val()+'&tanggal_tetap='+$('#tanggal-penetapan').val());
...
$(document).ready(function () {
	...
	$('#cetak').click(function(){
		$('#modal-cnt').html("<center><br><br><img src='images/loading.gif' /><br>Loading<br><br></center>");		
			$.post( "modul/hotel/gen_pdf_teguran_massal.php", { thn_pajak: $('#tahun-pajak').val(), bln_pajak: $('#bulan-pajak').val() , teguran_ke: $('#teguran-ke').val()})
  						.done(function( data1 ) {
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>                                           
				<h4 class="modal-title" id="myModalLabel">Surat Teguran SPTPD</h4>
			</div>
...
<form id="frm-restoran-skp-mas" name="frm-hotel-skp-mas" data-parsley-validate class="form-horizontal form-label-left">
