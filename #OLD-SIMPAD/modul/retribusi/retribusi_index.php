...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
				...
				<h2>Pendapatan Asli Daerah (PAD)</h2>
			<div class="x_title">
			</div>
			<div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true" onClick="load_content_tab_bill('penyerahan_bill.php','')">Input Pendapatan Asli Daerah (PAD)</a>
                                            </li>											
                                            										
                                        </ul>
										<div id="contenttab">
										<?php include_once $_SESSION['base_dir']."modul/retribusi/retribusi.php"; ?>
										</div>
			</div>
