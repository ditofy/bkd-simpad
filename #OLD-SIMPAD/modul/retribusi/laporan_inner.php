		...
		if($("#opd").val() != null) {
			...
			$('#cetak-inner').click(function(){
					if($('#tgl-awal').val() == ''  || ('#tgl-akhir').val == ''){
						...
						$.post( "modul/retribusi/gen_pdf_inner_tanggal.php", {tgl_awal: $('#tgl-awal').val(),tgl_akhir: $('#tgl-akhir').val() }).done(function( data1 ) {
...
<div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
							...
							<div class="row x_title">
                                <div class="col-md-6">
                                <h3><small>DETAIL PENERIMAAN RETRIBUSI PER INNER</small></h3>    
                                </div>
...
<form id="frm-laporan-inner" name="frm-laporan-inner" data-parsley-validate class="form-horizontal form-label-left">
	...
	<div class="form-group">
    	<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
			...
			<button id="cetak-inner" type="button" class="btn btn-dark" data-toggle="modal" data-target=".bs-example-modal-lg">Cetak</button>        </div>
    </div>
</form>
<div id="list-inner">
