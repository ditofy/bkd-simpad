...
$jns_rincian = $_REQUEST['jns_rincian'];
...
$link_pdf = "\"".$base_url."print/r_pajak_rinci.php?jns-rincian=".$jns_rincian."&nip=".$nip."&nama=".$nama."&tgl-pembayaran=".$tgl_bayar."&bdir=".$base_dir."\"";
