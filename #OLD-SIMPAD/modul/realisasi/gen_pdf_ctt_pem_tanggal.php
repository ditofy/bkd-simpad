...
$jns_laporan = $_REQUEST['jns_laporan'];
$jns_objek = $_REQUEST['jns_objek'];
...
$link_pdf = "\"".$base_url."print/r_pajak_tanggal.php?jns-objek=".$jns_objek."&nip=".$nip."&nama=".$nama."&tgl-awal=".$tgl_awal."&tgl-akhir=".$tgl_akhir."&jns-laporan=".$jns_laporan."&bdir=".$base_dir."\"";
$pdf_gen_param = $pdf_gen." --page-height $height --page-width $width ".$link_pdf;
