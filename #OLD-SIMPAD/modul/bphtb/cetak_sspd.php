...
$(document).ready(function () {
	...
	$('#frm-cetak-sspd').submit(function() {
  		return false;
	});
...
<div class="form-group">
    ...
    <div class="col-md-6 col-sm-6 col-xs-12">
    	<input type="text" id="no-sspd" name="no-sspd" class="form-control col-md-7 col-xs-12" placeholder="Nomor SSPD BPHTB" data-inputmask="'mask': '99.9999.99.99.9999'">
    </div>
</div>
	<div class="form-group">
...
<form id="frm-ctk-sspd" name="frm-ctk-sspd" data-parsley-validate class="form-horizontal form-label-left">
<div class="form-group">
...
<div class="form-group">
    	<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">			
			<button id="cetak-msl-sspd" type="button" class="btn btn-dark" data-toggle="modal" data-target=".bs-example-modal-lg">Cetak SSPD Masal</button>			
		</div>
</div>
</form>