...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
				<h2>Simulasi Kenaikan PBB Rinci</h2>
			<div class="x_title">
			</div>
...
<button type="button" class="btn btn-success" id="submit-tampilkan-kenaikan">Tampilkan Data Rekelas</button>
</td>
</tr>
</table>
		<div class="col-md-12 col-sm-3 col-xs-12 bg-white" id="data-kenaikan">		
...
<script>
    $(document).ready(function () {
			...
			$('#submit-tampilkan-kenaikan').click(function(){
					if($('#naik').val() != '') {
						$('#data-kenaikan').html("<img src='images/loading.gif' />");
						$("#submit-tampilkan-kenaikan").attr("disabled", "disabled");
						$.post( "modul/bphtb/cari_kenaikan.php", { naik: $('#naik').val(), ratio: $('#ratio').val()})
  						.done(function( data ) {
   						$('#data-kenaikan').html(data);
							$("#submit-tampilkan-kenaikan").removeAttr('disabled');
  						});
					} else {
