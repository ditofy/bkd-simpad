...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
				<h2>Simulasi Kenaikan NJOP PBB</h2>
			<div class="x_title">
			</div>
...
<td>
<div class="col-md-4 col-sm-6 col-xs-12 form-group has-feedback">
<input type="text" id="kelas" name="kelas" class="form-control col-md-7 col-xs-12" placeholder="Input Kenaikan Kelas">
</div>
</td></tr>
<tr>
<td colspan="2" align="center">
<button type="button" class="btn btn-success" id="submit-simulasi-njop">Tampilkan Simulasi Kenaikan Data NJOP</button>
</td>
</tr>
</table>
		<div class="col-md-12 col-sm-3 col-xs-12 bg-white" id="simulasi-data-njop">		
...
function get_kel(kd) {
	if(kd != ""){
        ...
        $(document).ready(function () {
			...
			$('#submit-simulasi-njop').click(function(){
					if($('#kd-kecamatan').val() != '') {
						$('#simulasi-data-njop').html("<img src='images/loading.gif' />");
						$("#submit-simulasi-njop").attr("disabled", "disabled");
						$.post( "modul/bphtb/simulasi_njop.php", { kd_kecamatan: $('#kd-kecamatan').val(), kd_kelurahan: $('#kd-kelurahan').val(), kelas: $('#kelas').val()})
  						.done(function( data ) {
   						$('#simulasi-data-njop').html(data);
							$("#submit-simulasi-njop").removeAttr('disabled');
  						});
					} else {
