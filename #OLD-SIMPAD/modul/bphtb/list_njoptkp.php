...
$cek_njoptkp = oci_parse($conn,"SELECT A.KD_PROPINSI||'.'||A.KD_DATI2||'.'||A.KD_KECAMATAN||'.'||A.KD_KELURAHAN||'.'||A.KD_BLOK||'-'||A.NO_URUT||'.'||A.KD_JNS_OP AS NOP,A.NM_WP_SPPT,C.SUBJEK_PAJAK_ID,A.NJOPTKP_SPPT,A.JLN_WP_SPPT FROM PBB.SPPT A 
...
WHERE NM_WP_SPPT LIKE '%$nm_wp%' AND THN_PAJAK_SPPT='2024' AND STATUS_PEMBAYARAN_SPPT < '2'
ORDER BY NOP ASC");
...
?>                                        
                                            <tr class="even pointer">
                                                ...
                                                <td class=" "><?php echo $hasil_cek_njoptkp['NM_WP_SPPT']; ?></td>
												 <td class=" "><?php echo $hasil_cek_njoptkp['JLN_WP_SPPT']; ?></td>
                                               <td class=" "><?php echo number_format($hasil_cek_njoptkp['NJOPTKP_SPPT']); ?></td>                                     
                                            </tr>
