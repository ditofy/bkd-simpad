...
$(document).ready(function () {
  $(".select2_single").select2({
        ...
        $(this).keypress(function (ev) {
			...
			$("#nop").enterKey(function () {
				...
				/*	$("#nop").attr("readonly", "readonly"); */
   					$.post( "inc/get_data_nop_pbb_bphtb.php", { nop: $('#nop').val() })
  						.done(function( data1 ) {							
	...
	$("#proses-update-pbb-bphtb").attr("disabled", "disabled");
	var inputs = $('#frm-update-pbb-bphtb').serializeArray();
					$.post( "modul/bphtb/p_update_pbb.php", { postdata: inputs,lang:lang })
  						.done(function( data1 ) {
   							notif('Notifikasi',data1,'success');
							$('#resetfrm').click();
							$("#proses-update-pbb-bphtb").removeAttr('disabled');
  					});
...
<form id="frm-update-pbb-bphtb" name="frm-update-pbb-bphtb" data-parsley-validate class="form-horizontal form-label-left">
...
<div class="form-group">
	...
	<div class="form-group">
	 ...
	 <div class="x_panel">
                                <div class="x_title">
                                    <h2>DATA WAJIB PAJAK SIMPAD BPHTB</h2>   <div class="clearfix"></div>
									
  <div class="form-group">
		<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">NIK
    	</label>
    	<div class="col-md-6 col-sm-6 col-xs-12">
    		<input type="text" id="nik-wp" name="nik-wp" class="form-control col-md-7 col-xs-12" placeholder="Nomor Induk Kependudukan">
    	</div>
    </div>
	...
	<div class="form-group">
		<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Blok
		</label>
        <div class="col-md-6 col-sm-6 col-xs-12">
        	<input type="text" id="blok-wp" name="blok-wp" class="form-control col-md-7 col-xs-12"  placeholder="Blok Wajib Pajak">
        </div>
	</div>
	<div class="form-group">
		<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">RT
		</label>
        <div class="col-md-6 col-sm-6 col-xs-12">
        	<input type="text" id="rt-wp" name="rt-wp" class="form-control col-md-7 col-xs-12"  placeholder="RT Wajib Pajak" >
        </div>
	</div>
	<div class="form-group">
		<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">RW
		</label>
        <div class="col-md-6 col-sm-6 col-xs-12">
        	<input type="text" id="rw-wp" name="rw-wp" class="form-control col-md-7 col-xs-12"  placeholder="RW Wajib Pajak" >
        </div>
	</div>
	<div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
        	<input type="text" id="kelurahan-wp" name="kelurahan-wp" class="form-control col-md-7 col-xs-12"  placeholder="Kelurahan Wajib Pajak">
        </div>
	</div>
	<div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
        	<input type="text" id="kecamatan-wp" name="kecamatan-wp" class="form-control col-md-7 col-xs-12"  placeholder="Kecamatan Wajib Pajak">
        </div>
	</div>
	<div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
        	<input type="text" id="kota-wp" name="kota-wp" class="form-control col-md-7 col-xs-12"  placeholder="Kabupaten / Kota Wajib Pajak">
        </div>
	</div>
	...
	<div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
        	<input type="text" id="no-telp-wp" name="no-telp-wp" class="form-control col-md-7 col-xs-12"  placeholder="No Telepon">
        </div>
	</div>
	...
	<div class="form-group">
    	<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
        	<button id="proses-daftar-bphtb" type="button" class="btn btn-success">Update Data</button>
