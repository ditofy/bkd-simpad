...
$queryUpdateWP = "UPDATE PBB.DAT_SUBJEK_PAJAK SET NM_WP='$nama_wp',JALAN_WP='$alamat_wp',BLOK_KAV_NO_WP='$blok_wp',RW_WP='$rw_wp',RT_WP='$rt_wp',KELURAHAN_WP='$kelurahan',KOTA_WP='$kota',TELP_WP='$telp' WHERE SUBJEK_PAJAK_ID='$nik'";
$stidUpdateWP = oci_parse($conn, $queryUpdateWP);	
$update_data_wp=oci_execute($stidUpdateWP);
