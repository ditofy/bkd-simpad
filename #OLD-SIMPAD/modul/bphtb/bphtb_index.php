		...
		<div class="x_panel">
			...
			<div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
											...
											<li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab"  aria-expanded="true" onClick="load_content_tab('update_berkas.php','')">Update Berkas Pelayanan</a>
                                            </li>
											
                                        </ul>
										<div id="contenttab">
										<?php include_once $_SESSION['base_dir']."modul/bphtb/pendaftaran.php"; ?>
										</div>
			</div>
