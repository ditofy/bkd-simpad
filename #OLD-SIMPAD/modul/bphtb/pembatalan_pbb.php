...
$(document).ready(function () {
  $(".select2_single").select2({
	...
	$("#proses-batal-pbb").attr("disabled", "disabled");
	var inputs = $('#frm-batal-pbb').serializeArray();
					$.post( "modul/bphtb/p_batal_pbb.php", { postdata: inputs,lang:lang })
  						.done(function( data1 ) {
   							notif('Notifikasi',data1,'success');
							$('#resetfrm').click();
							$("#proses-batal-pbb").removeAttr('disabled');
  					});
...
<form id="frm-batal-pbb" name="frm-batal-pbb" data-parsley-validate class="form-horizontal form-label-left">
...
<div class="form-group">
	...
	<div class="form-group">
    	<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
        	<button id="proses-daftar-bphtb" type="button" class="btn btn-success">Batal Data</button>
