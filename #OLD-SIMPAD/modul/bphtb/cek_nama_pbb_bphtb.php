...
function list_data(pg) {
	$('#list-pbb-bphtb').html("<center><br><br><img src='images/loading.gif' /><br>Loading<br><br></center>");	
	var inputs = $('#filter-data').serializeArray();	
			$.post( "modul/bphtb/list_pbb_bphtb.php", { postdata: inputs, page: pg })
  						.done(function( data1 ) {
							$('#list-pbb-bphtb').html(data1);
  					});
};
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>                                           
				<h4 class="modal-title" id="myModalLabel">DATA WAJIB PAJAK PBB TRANSAKSI BPHTB</h4>
			</div>
