...
$(document).ready(function () {
	...
	$('#proses-skpdkb-restoran').click(function(){
		if( $('#nop').val() == '' || $('#pajak-setor').val() == '' || $('#pajak-baru').val() == null || $('#dasar-pengenaan-pajak').val() == '' || $('#tanggal-penyampaian').val() == '' ) {
			notif('Notifikasi','Isi Semua Data','error');
		} else {
			$("#proses-skpdkb-restoran").attr("disabled", "disabled");
			var inputs = $('#frm-restoran-skpdkb').serializeArray();
					$.post( "modul/skpdkb/penyampaian_p_simpan_skpdkb.php", { postdata: inputs })
  						.done(function( data1 ) {
							...
							if( obj.status == "ok") {
								...
								notif('Notifikasi','SKPDKB ini sudah Dientrikan ','warning');
								$("#no-skpdkb").val(obj.no_skpdkb);
								$("#cetak").removeAttr('disabled');								
							} 
...
<form id="frm-restoran-skpdkb" name="frm-restoran-skpdkb" data-parsley-validate class="form-horizontal form-label-left">
...
<div class="form-group">
	<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Pajak Terutang</label>
    	<div class="col-md-3 col-sm-6 col-xs-12">
    		<input type="text" id="pajak-baru" name="pajak-baru" class="form-control col-md-7 col-xs-12" placeholder="Pajak Terutang Yang Baru" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);">
    	</div>
</div>
<div class="form-group">
	<label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Pajak Yg Telah Di Setor</label>
    	<div class="col-md-3 col-sm-6 col-xs-12">
    		<input type="text" id="pajak-setor" name="pajak-setor" class="form-control col-md-7 col-xs-12" placeholder="Pajak Yang Telah Di Setor" onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);">
    	</div>
</div>
<div class="form-group">
...
<div class="form-group">
	...
	<div class="form-group">
    	<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
        	<button id="proses-skpdkb-restoran" type="button" class="btn btn-success">Simpan</button>
