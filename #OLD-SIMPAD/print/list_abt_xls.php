...
<center>DATA OBJEK PAJAK AIR TANAH</center>
<br />
...
?>                                        
                                            <tr class="even pointer">
												...
												<td class=" "><?php echo $row['ketetapan']; ?></td>
