...
<table width="100%"><tr><td width="50%" align="center">Pemungut</td><td align="center">Mengetahui:</td></tr>
<?php 
$jab=pg_query("select * from public.user where jabatan='KEPALA UPTB PAJAK DAERAH'");
$u=pg_fetch_array($jab);
$pem=pg_query("select A.nama,A.nip from public.user A INNER JOIN $schema.pembayaran B
ON A.nip=B.pemungut where B.pemungut = '$pemungut'");
$re=pg_fetch_array($pem);
?>
<tr><td width="50%"></td><td align="center"><?php echo $u['jabatan']; ?></td></tr>
<tr height="45"><td width="50%"></td><td align="center"></td></tr>
<tr><td width="50%" align="center" ><?php echo $re['nama']; ?></td><td align="center"><?php echo $u['nama']; ?></td></tr>
<tr><td width="50%" align="center">Nip.&nbsp;<?php echo $re['nip']; ?></td><td align="center">Nip.&nbsp;<?php echo $u['nip']; ?></td></tr>
</table>
<?php
