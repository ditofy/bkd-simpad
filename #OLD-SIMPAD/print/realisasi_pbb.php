...
echo "<title>Realisasi PBB</title>";
$tahun_pajak = pg_escape_string($_GET['thnpajak']);
//$tahun_pajak = '2015';
$kecamatan = pg_escape_string($_GET['kecamatan']);
//echo $bdir." ".$tahun_pajak." ".$kecamatan;
/*$awal = "01/01/".$tahun_pajak;
...
$akhir = "30/09/2024";
$rows = array();
list($kd_propinsi,$kd_dati2,$kd_kecamatan,$nm_kecamatan) = explode(".",$kecamatan);
list($tgl_a,$bln_a,$thn_a) = explode("/",$awal);
list($tgl_ak,$bln_ak,$thn_ak) = explode("/",$akhir);
...
<center>REALISASI PBB-P2 KOTA PAYAKUMBUH</center>
<center>TAHUN PAJAK <?php echo $tahun_pajak; ?></center>
<center>PERIODE <?php echo $tgl_a." ".$bulan[(int)$bln_a]." ".$thn_a." S/D ".$tgl_ak." ".$bulan[(int)$bln_ak]." ".$thn_ak; ?></center><br />
...
?>
<center>REALISASI PBB-P2 KECAMATAN <?php echo strtoupper($nm_kecamatan); ?></center>
<center>TAHUN PAJAK <?php echo $tahun_pajak; ?></center>
<center>PERIODE <?php echo $tgl_a." ".$bulan[(int)$bln_a]." ".$thn_a." S/D ".$tgl_ak." ".$bulan[(int)$bln_ak]." ".$thn_ak; ?></center><br />
<table border="1" style="font-size:12px;border:1px solid black;border-collapse:collapse;" align="center" cellpadding="2px" width="100%">
	<thead>
...
unset($rows);
oci_close($conn);
include_once $bdir."print/ttd_kabid.php";
?>