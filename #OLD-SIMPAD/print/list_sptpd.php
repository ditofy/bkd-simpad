...
<center>DATA SURAT PEMBERITAHUAN PAJAK DAERAH
...
<table width="100%" border="0"><tr><td width="50%" align="center"><!--Mengetahui :--></td><td width="10%"></td><td align="center">Payakumbuh, <?php echo strtoupper(date('d-M-Y')); ?></td></tr>
<?php 
$jab=pg_query("select * from public.user where username='nova'");
$u=pg_fetch_array($jab);
?>
<tr><td align="center"><!--Kepala Badan Keuangan Daerah--></td><td width="10%"></td><td align="center"><?php echo $u['jabatan']; ?></td></tr>
<tr height="60"><td width="10%"></td><td align="center"></td></tr>
<tr><td align="center"><!--Drs. SYAFWAL, MM<--></td><td width="10%"></td><td align="center"><?php echo $u['nama']; ?></td></tr>
<tr><td align="center"><!--Nip. 19690116 199009 1 001--></td><td width="10%"></td><td align="center">Nip.&nbsp;<?php  echo $u['nip']; ?></td></tr>
</table>
<?php
