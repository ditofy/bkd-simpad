	...
	{ 
		...
		if( ($data[0] == $user) and ($data[1] == $pass) and ($data[5] == '1'))
		{
			...
			if (!isset($_SESSION['user'])) {
				...
				//linux
				//$_SESSION['base_dir'] = "/home/simpad-dev/public_html/";
				//$_SESSION['PDF_GEN'] = "/home/simpad-dev/wkhtmltox/bin/wkhtmltopdf";
				//$_SESSION['base_url'] =  "http://simpad-dev.payakumbuhkota.go.id/";
				//$_SESSION['TMP_FOLDER'] = "/home/simpad-dev/public_html/tmp/".$_SESSION['user']."/";
				
				//windows
				$_SESSION['base_dir'] = "C:/wamp/www/";
				$_SESSION['base_url'] =  "http://localhost/";				
				$_SESSION['PDF_GEN'] = "C:\wkhtmltopdf\bin\wkhtmltopdf.exe";
				$_SESSION['TMP_FOLDER'] = "C:/wamp/www/tmp/".$_SESSION['user']."/";
